            ...
            <main>
                <section id="features" className="container mx-auto px-4 space-y-6 bg-slate-50 py-8 md:py-12 lg:py-20">
                    ...
                    <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                        ...
                        <h2 className="font-bold text-lg leading-[1.1] sm:text-lg md:ttext-lg">
                            Prabhu Bank Services</h2>
                        ...
                        <div
                            ...
                            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">App dir, Routing, Layouts, Loading UI
                                        and API routes.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">ORM using Prisma and deployed on
                                        PlanetScale.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">UI components built using Radix UI and
                        ...
                        <div
                            ...
                            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Authentication using NextAuth.js and
                                        middlewares.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Free and paid subscriptions using
                                        Stripe.</p>
                                </div>
                            </div>
                        </div>
